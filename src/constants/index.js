...
export const EXPERIENCES = [
  {
    ...
    Integrated APIs to fetch and display dynamic data, enhancing interactive capabilities of web applications.
    Developed multiple re-usable component,enhancing the scalability and reusability of the codebase, cutting new project
    development time by 40%.
    Optimized web pages for cross-browser compatibility and mobile responsiveness, improving the overall user experience.Utilized CSS frameworks (Bootstrap, Material UI) to streamline the development process and ensure consistent design.
    Optimized application performance and load times by applying lazy loading optimization technique.`,
